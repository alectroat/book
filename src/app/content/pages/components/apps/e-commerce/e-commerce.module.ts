...
// Products
import { OverviewListComponent } from './products/_subs/overview/overview-list/overview-list.component';
//import { ProductsLinksComponent } from './products/product-links/products-links.component';
...
import { ProductFactsComponent } from './products/product-facts/product-facts.component';
import { ProductMapComponent } from './products/product-map/product-map.component'; 
import { ProductMediaComponent } from './products/product-media/product-media.component';
import { ProductDatetimeComponent } from './products/product-datetime/product-datetime.component';
...
const routes: Routes = [
	{
		...
		children: [
			...
			{
				path: 'products/facts',
				component: ProductFactsComponent
			},
			{
				path: 'products/price',
			...
			{
				path: 'products/media',
				component: ProductMediaComponent
			}, 
			{
				path: 'products/datetime',
				component: ProductDatetimeComponent
			}, 
			//{
			//	path: 'products/links',
			//	component: ProductsLinksComponent
			//}, 
			{
...
@NgModule({
	imports: [
		...
		AgmCoreModule.forRoot({
			apiKey: 'AIzaSyCyfRFp3mJBdh4Vw7Jr0Ta4WxgNf0huMYU'
		}),
