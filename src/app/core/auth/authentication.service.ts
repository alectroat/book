...
export class AuthenticationService implements AuthService {
	...
	public readonly serviceEndpoint = 'http://booknordicsapi.azurewebsites.net/';
	public readonly apiUrl = this.serviceEndpoint + "api/v1.0/"
	...
	public login(credential: Credential): Observable<any> {
		...
		//let body = JSON.stringify({ "email": credential.email, 'password': credential.password });
		...
		//			alert(res);
		//			if (res && res.record.token) {
		//				// store user details and jwt token in local storage to keep user logged in between page refreshes
		//				localStorage.setItem('currentUser', JSON.stringify(res.record));
		//			}
		//		}),
